        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-xl font-bold pb-2 text-[#00FFCA]">
              Hello Justin Bituin, it's a pleasure to meet you
            </p>
            {/* Description */}
            <p className="text-sm leading-7">
            I'm computer engineering student with a passion for coding. I may be a beginner, but my enthusiasm for learning is boundless. Join me on my journey
